...
COMPONENT_CSS = """\
.ui-page-header{display:flex;min-height:112px;justify-content:space-between;gap:24px;align-items:flex-start;margin:0;padding:4px 0 22px}.ui-page-header__eyebrow{margin-bottom:6px;color:var(--accent);font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.ui-page-header h1{font-family:var(--font-display);color:var(--text-primary);font-size:38px;line-height:1.1;letter-spacing:-.035em}.ui-page-header__summary{max-width:680px;margin-top:8px;color:var(--text-secondary);font-size:14px;line-height:1.65}.ui-page-header__actions{display:flex;gap:8px;flex-wrap:wrap}
