...
@media(max-width:768px){.research-layout,.report-grid{grid-template-columns:1fr}.research-settings{grid-template-columns:1fr}.form-footer{align-items:stretch;flex-direction:column}.research-submit,.research-submit .ui-button{width:100%}.progress-grid{grid-template-columns:1fr}.report-header{align-items:flex-start;flex-direction:column}}@media(max-width:480px){.research-form{gap:15px}.research-layout{gap:12px}.output-placeholder{min-height:220px;padding:30px 18px}.timeline-item{grid-template-columns:1fr;gap:3px}.report-section{padding:15px}}
"""
...
<div class="research-settings"><div class="depth-field"><label class="field-label" for="research-depth" data-i18n="research_depth_label">{t("research_depth_label", lang)}</label><select class="depth-select" id="research-depth"><option value="standard" data-i18n="research_depth_standard">{t("research_depth_standard", lang)}</option><option value="deep" data-i18n="research_depth_deep">{t("research_depth_deep", lang)}</option></select></div><label class="agent-toggle"><input type="checkbox" id="research-agent"><span data-i18n="research_agent_mode">{t("research_agent_mode", lang)}</span></label></div>
<div class="form-footer"><p class="research-status" id="research-status" aria-live="polite"></p><div class="research-submit">{submit}</div></div></form>'''
    guide = ''.join(
