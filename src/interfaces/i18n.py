...
I18N: dict[str, dict[str, str]] = {
    ...
    # ── Star5 Reader ──
    "star5_picks":        {"zh": "★5 精选", "en": "★5 Picks"},
    "star5_all_read":     {"zh": "全部已读完", "en": "All caught up"},
    "star5_all_read_hint": {"zh": "换个时间范围试试", "en": "Try a different range"},
    "star5_no_articles":  {"zh": "该时间范围内暂无 ★5 文章", "en": "No ★5 articles in this range"},
    ...
    "prev_year":          {"zh": "上一年", "en": "Previous"},
    "next_year":          {"zh": "下一年", "en": "Next"},
    "clear":              {"zh": "清除", "en": "Clear"},
    ...
    "my_search_placeholder":    {"zh": "搜索沉淀内容或标签…", "en": "Search library items or tags…"},
    ...
    "my_favorites":             {"zh": "我的沉淀", "en": "My Library"},
    "my_overview":              {"zh": "收藏概览", "en": "Saved Overview"},
    "my_saved_count":           {"zh": "沉淀内容", "en": "Library items"},
    ...
    "reading_later":            {"zh": "稍后", "en": "Read later"},
    ...
    "reader_toc_toggle":        {"zh": "目录", "en": "Contents"},
    "reader_back_to_content":   {"zh": "返回正文", "en": "Back to Content"},
    "reader_prev_article":      {"zh": "← 上一篇", "en": "← Previous"},
    "reader_next_article":      {"zh": "下一篇 →", "en": "Next →"},
    "reader_no_more_articles":  {"zh": "已是最后一篇", "en": "You've reached the end"},
    ...
    "my_empty_favorites":       {"zh": "还没有沉淀内容", "en": "Your library is empty"},
    "my_empty_favorites_desc":  {"zh": "收藏、已读和稍后的新闻、报告及专题内容会统一进入这里。", "en": "Saved, read, and later items from news, reports, and topics appear here."},
